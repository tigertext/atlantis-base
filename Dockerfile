...
# We only bake in the default Terraform version. 1.8.5, 1.9.8, and 1.10.5 are EOL'd
# with a vulnerable hashicorp/go-getter (CVE-2024-6257, CVE-2025-8959), so bundling
# them fails the container CVE scan. Any project pinning another version downloads
# it on demand at runtime (--tf-download defaults to true).
